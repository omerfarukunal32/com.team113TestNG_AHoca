...
public class C03_DataProvider {
    /*
        dataProvider testNG'nin test method'u disindan test'e data saglamak icin olusturdugu ozel bir yapidir
    ...
    public void test01(String aranacakKelime){
        ...
        // bize list olarak verilenurunlerin hepsi icin
        // arama kutusuna yazip arama yapin
        AmazonPage amazonPage = new AmazonPage();
        amazonPage.aramaKutusu.sendKeys(aranacakKelime);
